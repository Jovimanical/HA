...
// get id of ha_gateway_currencies to be edited
$data = json_decode(file_get_contents("php://input"));
 
// set ID property of ha_gateway_currencies to be edited
$ha_gateway_currencies->id = $data->id;

if(
!isEmpty($data->min_amount)
...
if($ha_gateway_currencies->update()){
...
// if unable to update the ha_gateway_currencies, tell the user
else{
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update ha_gateway_currencies","data"=> ""));
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update ha_gateway_currencies. Data is incomplete.","data"=> ""));
}
?>
