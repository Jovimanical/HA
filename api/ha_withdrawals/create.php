...
// instantiate ha_withdrawals object
...
if (!isEmpty($data->method_id)
    ...
    $lastInsertedId = $ha_withdrawals->create();
    // create the ha_withdrawals
    if ($lastInsertedId != 0) {
    ...
    } // if unable to create the ha_withdrawals, tell the user
    else {
        ...
        // tell the user
        echo json_encode(array("status" => "error", "code" => 0, "message" => "Unable to create ha_withdrawals", "data" => ""));
    }
    ...
    // tell the user
    echo json_encode(array("status" => "error", "code" => 0, "message" => "Unable to create ha_withdrawals. Data is incomplete.", "data" => ""));
}
?>
