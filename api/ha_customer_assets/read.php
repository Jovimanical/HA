...
// read ha_customer_assets will be here

// query ha_customer_assets
$stmt = $ha_customer_assets->read();
$num = $stmt->rowCount();
...
if ($num > 0) {
    ...
    $ha_customer_assets_arr["total_count"] = $ha_customer_assets->total_user_record_count();
    ...
    echo json_encode(array("status" => "error", "code" => 0, "message" => "No ha_customer_assets found.", "data" => null));
