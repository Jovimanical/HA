...
if($ha_customer_other_income->delete()){
    ...
    // tell the user
	echo json_encode(array("status" => "success", "code" => 1,"message"=> "Ha_Customer_Other_Income was deleted","document"=> ""));
    
}
 
// if unable to delete the ha_customer_other_income
else{
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to delete ha_customer_other_income.","document"=> ""));
}
?>
