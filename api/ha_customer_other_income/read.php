...
// read ha_customer_other_income will be here

// query ha_customer_other_income
$stmt = $ha_customer_other_income->read();
$num = $stmt->rowCount();
...
if ($num > 0) {
    ...
    $ha_customer_other_income_arr["total_count"] = $ha_customer_other_income->total_user_record_count();
    ...
    echo json_encode(array("status" => "error", "code" => 0, "message" => "No ha_customer_other_income found.", "data" =>null));
