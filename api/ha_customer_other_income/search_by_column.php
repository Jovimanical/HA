...
$stmt = $ha_customer_other_income->searchByColumn($data,$orAnd);
...
if($num>0){
    ...
    $ha_customer_other_income_arr["total_count"]=$ha_customer_other_income->search_record_count($data,$orAnd);
