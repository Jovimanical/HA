...
// get meeting_schedules id
$data = json_decode(file_get_contents("php://input"));

// set meeting_schedules id to be deleted
$meeting_schedules->id = $data->id;

// delete the meeting_schedules
if ($meeting_schedules->delete()) {

    // set response code - 200 ok
    http_response_code(200);

    // tell the user
    echo json_encode(array("status" => "success", "code" => 1, "message" => "Meeting_Schedules was deleted", "data" => ""));

} // if unable to delete the meeting_schedules
else {
    ...
    // tell the user
    echo json_encode(array("status" => "error", "code" => 0, "message" => "Unable to delete meeting_schedules.", "data" => ""));
}
?>
