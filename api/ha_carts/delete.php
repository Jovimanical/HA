...
if ($ha_carts->delete()) {
    ...
    // tell the user
    echo json_encode(array("status" => "success", "code" => 1, "message" => "Ha_Carts was deleted", "data" => ""));
    ...
    // tell the user
    echo json_encode(array("status" => "error", "code" => 0, "message" => "Unable to delete ha_carts.", "data" => ""));
}
?>
