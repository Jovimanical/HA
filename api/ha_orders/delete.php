...
if($ha_orders->delete()){
    ...
    // tell the user
	echo json_encode(array("status" => "success", "code" => 1,"message"=> "Ha_Orders was deleted","data"=> ""));
...
// if unable to delete the ha_orders
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to delete ha_orders.","data"=> ""));
}
?>
