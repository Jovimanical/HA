...
// set ha_wishlists id to be deleted
$ha_wishlists->id = $data->id;
 
// delete the ha_wishlists
if($ha_wishlists->delete()){
 
    // set response code - 200 ok
    http_response_code(200);
 
    // tell the user
	echo json_encode(array("status" => "success", "code" => 1,"message"=> "Ha_Wishlists was deleted","document"=> ""));
    
}
 
// if unable to delete the ha_wishlists
else{
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to delete ha_wishlists.","document"=> ""));
}
?>
