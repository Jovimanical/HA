...
// query ha_wishlists
$stmt = $ha_wishlists->searchByColumn($data, $orAnd);
...
if ($num > 0) {
    ...
    $ha_wishlists_arr["total_count"] = $ha_wishlists->search_record_count($data, $orAnd);
    ...
    echo json_encode(array("status" => "error", "code" => 0, "message" => "No ha_wishlists found.", "data" => ""));
