...
$ha_properties->pageNo = isset($_GET['pageno']) ? $_GET['pageno'] : 1;
$ha_properties->no_of_records_per_page = isset($_GET['pagesize']) ? $_GET['pagesize'] : 30;

// query ha_properties
$stmt = $ha_properties->searchByColumn($data,$orAnd);
...
if($num>0){
    ...
    $ha_properties_arr["total_count"]=$ha_properties->search_record_count($data,$orAnd);
...
"deleted_at" => $deleted_at
 ...
 // no ha_properties found will be here
	...
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "No ha_properties found.","data"=> ""));
