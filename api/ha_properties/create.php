...
// instantiate ha_properties object
...
$ha_properties->deleted_at = $data->deleted_at;
 	$lastInsertedId=$ha_properties->create();
    // create the ha_properties
    if($lastInsertedId!=0){
    ...
    // if unable to create the ha_properties, tell the user
    else{
        ...
        // tell the user
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create ha_properties","data"=> ""));
    }
}
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create ha_properties. Data is incomplete.","data"=> ""));
}
?>
