...
if(!isEmpty($ha_kyc_employment_status->id)){
 
// update the ha_kyc_employment_status
if($ha_kyc_employment_status->update_patch($data)){
...
// if unable to update the ha_kyc_employment_status, tell the user
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update ha_kyc_employment_status","document"=> ""));
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update ha_kyc_employment_status. Data is incomplete.","document"=> ""));
}
?>
