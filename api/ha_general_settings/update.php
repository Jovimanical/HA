...
// get id of ha_general_settings to be edited
$data = json_decode(file_get_contents("php://input"));
 
// set ID property of ha_general_settings to be edited
$ha_general_settings->id = $data->id;
...
// if unable to update the ha_general_settings, tell the user
else{
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update ha_general_settings","data"=> ""));
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update ha_general_settings. Data is incomplete.","data"=> ""));
}
?>
