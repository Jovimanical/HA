...
$stmt = $ha_admin_password_resets->searchByColumn($data,$orAnd);
...
if($num>0){
    ...
    $ha_admin_password_resets_arr["total_count"]=$ha_admin_password_resets->search_record_count($data,$orAnd);
