...
public $created_at;
	...
	function search($searchKey){
		...
		// select all query
		$query = "SELECT  t.* FROM ". $this->table_name ." t  WHERE t.email LIKE ? OR t.token LIKE ?  OR t.created_at LIKE ?  LIMIT ".$offset." , ". $this->no_of_records_per_page."";
...
$this->created_at = $row['created_at'];
	...
	function create(){
		...
		$query ="INSERT INTO ".$this->table_name." SET email=:email,token=:token";
...
$stmt->bindParam(":token", $this->token);
	...
	function update(){
		...
		// update query
		$query ="UPDATE ".$this->table_name." SET email=:email,token=:token WHERE ERROR_NOPRIMARYKEYFOUND = :ERROR_NOPRIMARYKEYFOUND";
