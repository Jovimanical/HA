...
// read ha_agents_password_resets will be here

// query ha_agents_password_resets
$stmt = $ha_agents_password_resets->read();
$num = $stmt->rowCount();
...
if($num>0){
    ...
    $ha_agents_password_resets_arr["total_count"]=$ha_agents_password_resets->total_record_count();
